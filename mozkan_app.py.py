...
<h2 style="color:white;text-align:center;">Auto-Scout Car Price Prediction</h2>
</div>"""
...
st.markdown('*Is The Model İmportant For You? Just Choose Then!!!*')
st.text('***Note:*** Compare the difference ! It will help you')
